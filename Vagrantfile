$script = <<-'SCRIPT'
	...
	sudo apt-get update && sudo apt-get install -y --no-install-recommends tzdata unzip zsh git curl wget vim locales sudo gnupg software-properties-common ca-certificates curl apt-transport-https lsb-release gnupg python3-pip python3-setuptools nodejs fonts-powerline libssl-dev libffi-dev python-dev-is-python3 build-essential exa
